    ...
    <footer className="bg-gray-800 text-white py-12 mt-auto">
      <div className="container mx-auto px-4">
        <div className="grid md:grid-cols-3 gap-8">
          <div>
            <h3 className="text-xl font-bold mb-4">Meeting Transcriber</h3>
            <p className="text-gray-300">
              Sistema inteligente para gravação, transcrição e análise de reuniões online, com foco no mercado brasileiro.
            </p>
          </div>
          <div>
            ...
            <ul className="space-y-2">
              ...
              <li><Link href="/privacy" className="text-gray-300 hover:text-white">Política de privacidade</Link></li>
            </ul>
          </div>
          <div>
            <h3 className="text-xl font-bold mb-4">Contato</h3>
            <p className="text-gray-300 mb-2">contato@meetingtranscriber.com.br</p>
        ...
        <div className="mt-8 pt-8 border-t border-gray-700 text-center text-gray-400">
          <p>&copy; {new Date().getFullYear()} Meeting Transcriber. Todos os direitos reservados.</p>
        </div>
      </div>
    </footer>
  );
